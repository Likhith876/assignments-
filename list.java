...
System.out.println(perfumecost);
...
System.out.println(creditcardrepaydate);
System.out.println(creditcardinterestrate);
System.out.println(creditcardexpiry);

String bulb="BULB INFO";
System.out.println(bulb);

String bulbbrand="Havells";
String bulbcolour="White";
String bulbtype="LED";
...
String apartment="APARTMENT INFO";
...
System.out.println(apartmentfloor);
System.out.println(apartmentparkings);
System.out.println(apartmentcost);
System.out.println(apartmentspecs);

String earphones="EARPHONE INFO";
...
System.out.println(earphonebrand);
System.out.println(earphoneprice);
System.out.println(earphonecolour);
System.out.println(earphonelatency);
System.out.println(earphoneconectivity);

String bag="BAG INFO";
System.out.println(bag);

String bagbrand="Safari";
...
System.out.println(bagcompartments);

String washingmachine="WASHING MACHINE INFO";
...
System.out.println(washingmachinetype);
System.out.println(washingmachinecolour);
System.out.println(washingmachineprice);
System.out.println(washingmachineload);

String powerbank="POWERBANK INFO";
...
System.out.println(watchcolour);
System.out.println(watchtype);
System.out.println(watchsize);

String mobile="MOBILE INFO";
...
System.out.println(mobilebattery);
